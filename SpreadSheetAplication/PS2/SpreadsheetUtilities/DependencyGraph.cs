...
namespace SpreadsheetUtilities
{
    ...
    public class DependencyGraph
    {
       ...
       private HashSet<string> depend;
        ...
        private void dependent(string s)
        {
            ...
            foreach (KeyValuePair<string, string> kvp in DG)
            {
                ...
                if (s == kvp.Key)
                {
                    ...
                    //find all the dependents of that value
                    dependent(kvp.Value);
        ...
        /// </summary>
        /// <param name="s">string - cell to be analized for dependendts</param>
        private void dependee(string s)
        {
